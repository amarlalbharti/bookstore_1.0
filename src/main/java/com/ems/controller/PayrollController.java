...
public class PayrollController {
	...
	public String getPayrollList(ModelMap map, HttpServletRequest request, Principal principal)
	{
	...
	public String addPayroll(ModelMap map, HttpServletRequest request, Principal principal)
	{
	...
	@RequestMapping(value = "/addPayrollSubmit", method = RequestMethod.GET)
	@ResponseBody
	public String addPayrollP(ModelMap map, HttpServletRequest request, Principal principal)
	{
...
//		}
	...
	@SuppressWarnings("unchecked")
	@RequestMapping(value = "/getPayrollReport", method = RequestMethod.GET)
	public String getPayrollReport(ModelMap map, HttpServletRequest request, Principal principal)
	{
		TimeZone timeZone = (TimeZone)request.getSession(true).getAttribute("timezone");
