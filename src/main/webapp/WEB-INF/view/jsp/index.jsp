	  				...
	  				<div class="col-sm-3 col-md-3 product">
						<div class="default">
						  <a href="${pageContext.request.contextPath}/<%= ProductUtils.getFriendlyUrl(product)%>" class="product-image">
							<img class="replace-2x" src="<%= productImage%>" alt="<%= product.getProductName()%>" title="" width="270" height="270">
						  </a>
						  <div class="actions not-rotation-actions">
							<a href="javascript:void(0);" title="Add to cart" class="add-cart" pid="<%= product.getPid()%>">
							...
							<a href="javascript:void(0);" title="Add to wishlist" class="add-wishlist">
							  <svg x="0" y="0" width="16px" height="16px" viewBox="0 0 16 16" enable-background="new 0 0 16 16" xml:space="preserve">
							...
							<a href="javascript:void(0);" title="Compare product" class="add-compare">
							  <svg x="0" y="0" width="16px" height="16px" viewBox="0 0 16 16" enable-background="new 0 0 16 16" xml:space="preserve">
						  ...
						  <div class="product-description">
							<div class="vertical">
							  ...
							  <div class="price"><i class="fa fa-rupee"></i> <%= product.getProductPrice()%></div>	
							</div>
						  </div>
						</div>
					  </div>
