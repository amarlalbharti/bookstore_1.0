...
<script type="text/javascript">
  ...
  function validate()
  {
	...
	var parmanentAddress=$(".edit-Form #parmanentAddress").val();
	var presentAddress=$(".edit-Form #presentAddress").val();
	var city=$(".edit-Form #city").val();
	var state=$(".edit-Form #state").val();
	var country=$(".edit-Form #country").val();
	var bloodGroup=$(".edit-Form #bloodGroup").val();
	var maritalStatus=$(".edit-Form #maritalStatus").val();
	var qualification=$(".edit-Form #qualification").val();
	var mobileNo=$(".edit-Form #mobileNo").val();
	var altEmailId=$(".edit-Form #altEmailId").val();
	...
	if(parmanentAddress==''){
		$(".edit-Form #parmanentAddress").parent().addClass("has-error")
		valid=false;
		}
	
	if(presentAddress==''){
		$(".edit-Form #presentAddress").parent().addClass("has-error")
		valid=false;
		}
	
	if(city==''){
		$(".edit-Form #city").parent().addClass("has-error")
		valid=false;
		}
	
	if(state==''){
		$(".edit-Form #state").parent().addClass("has-error")
		valid=false;
		}
	
	if(country==''){
		$(".edit-Form #country").parent().addClass("has-error")
		valid=false;
		}
	
	if(mobileNo==''||!ContactNo(mobileNo)){
		$(".edit-Form #mobileNo").parent().addClass("has-error")
		valid=false;
		}
	
		
	if(qualification==''){
		$(".edit-Form #qualification").parent().addClass("has-error")
		valid=false;
		}
	
	if(bloodGroup==''||bloodGroup=='Select Blood Group'){
		$(".edit-Form #bloodGroup").parent().addClass("has-error")
		valid=false;
		}
	
	if(maritalStatus==''||maritalStatus=='Select Marital Status'){
		$(".edit-Form #maritalStatus").parent().addClass("has-error")
		valid=false;
		}
	
	if(altEmailId==''||!isEmail(altEmailId)){
		$(".edit-Form #altEmailId").parent().addClass("has-error")
		valid=false;
		}
    ...
    $(".edit-Form #submit_btn").attr("disabled","disabled");
    
    $(".edit-Form #submit_btn").text("Updating...");
