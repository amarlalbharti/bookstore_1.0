...
<!--[if lte IE 8]>
  <script src="${pageContext.request.contextPath}/theme/js/jquery-1.9.1.min.js"></script>
<![endif]-->
<script src="${pageContext.request.contextPath}/theme/js/bootstrap.min.js"></script>
<!-- <script src="${pageContext.request.contextPath}/theme/js/price-regulator/jshashtable-2.1_src.js"></script> -->
<!-- <script src="${pageContext.request.contextPath}/theme/js/price-regulator/jquery.numberformatter-1.2.3.js"></script> -->
<!-- <script src="${pageContext.request.contextPath}/theme/js/price-regulator/tmpl.js"></script> -->
<!-- <script src="${pageContext.request.contextPath}/theme/js/price-regulator/jquery.dependClass-0.1.js"></script> -->
<!-- <script src="${pageContext.request.contextPath}/theme/js/price-regulator/draggable-0.1.js"></script> -->
<!-- <script src="${pageContext.request.contextPath}/theme/js/price-regulator/jquery.slider.js"></script> -->
<script src="${pageContext.request.contextPath}/theme/js/jquery.carouFredSel-6.2.1-packed.js"></script>
<script src="${pageContext.request.contextPath}/theme/js/jquery.touchwipe.min.js"></script>
<script src="${pageContext.request.contextPath}/theme/js/jquery.elevateZoom-3.0.8.min.js"></script>
...
<script src="${pageContext.request.contextPath}/theme/js/jquery.sparkline.min.js"></script>
<script src="${pageContext.request.contextPath}/theme/js/jquery.easypiechart.min.js"></script>
<script src="${pageContext.request.contextPath}/theme/js/jquery.easing.1.3.js"></script>
...
<script src="${pageContext.request.contextPath}/theme/js/jquery.knob.js"></script>
<script src="${pageContext.request.contextPath}/theme/js/jquery.selectBox.min.js"></script>
<script src="${pageContext.request.contextPath}/theme/js/jquery.royalslider.min.js"></script>
<script src="${pageContext.request.contextPath}/theme/js/jquery.tubular.1.0.js"></script>
<script src="${pageContext.request.contextPath}/theme/js/SmoothScroll.js"></script>
<script src="${pageContext.request.contextPath}/theme/js/country.js"></script>
<script src="${pageContext.request.contextPath}/theme/js/spin.min.js"></script>
<script src="${pageContext.request.contextPath}/theme/js/ladda.min.js"></script>
<script src="${pageContext.request.contextPath}/theme/js/masonry.pkgd.min.js"></script>
<script src="${pageContext.request.contextPath}/theme/js/morris.min.js"></script>
<script src="${pageContext.request.contextPath}/theme/js/raphael.min.js"></script>
<script src="${pageContext.request.contextPath}/theme/js/video.js"></script>
<script src="${pageContext.request.contextPath}/theme/js/pixastic.custom.js"></script>
<script src="${pageContext.request.contextPath}/theme/js/livicons-1.4.min.js"></script>
